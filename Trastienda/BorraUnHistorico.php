...
?>
<div>
    <h1>Borrar un Usuario del Histórico</h1>
</div>
<div>
    <?php
		// Recoge la variables 
        ...
        echo "<table class='bg-danger' style='width:60%; margin-left:20px; margin-right:40px;'> ";
        ...
        echo "<img src='$registro[7]' width='60'> · ";
        echo "<b>",$registro[7],"</b>";
        $foto=$registro[7];
        echo "</td></tr>";		
        }
...
<div class="bg-dark">    
    ...
    <div class="col-3 p-2 d-flex justify-content-center">   
        <form action="EliminaHistorico.php" method="post">           
